if (game:GetService("CoreGui")):FindFirstChild("ДИЛДОВАР") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
...
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("STELLAR")).Enabled = not (game.CoreGui:FindFirstChild("ДИЛДОВАР")).Enabled;
end);
